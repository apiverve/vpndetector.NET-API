...
namespace APIVerve
{
    public class VPNDetectorAPIClient
    {
        ...
        public VPNDetectorAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public VPNDetectorAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, VPNDetectorQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(VPNDetectorQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(VPNDetectorQueryOptions options)
        {
